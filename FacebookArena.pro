...
FacebookArenaRootPath=/media/bat/SecondSSD/Projects/Unreal/FacebookArena

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/FacebookArena/FacebookArena.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FacebookArenaSource.pri)
include(FacebookArenaHeader.pri)
include(FacebookArenaConfig.pri)
include(FacebookArenaIncludes.pri)
include(FacebookArenaDefines.pri)
...
FacebookArena-Linux-Debug.commands = $$build FacebookArena Linux Debug  -project="\"$$gameProjectFile\"" $$args
FacebookArena-Linux-DebugGame.commands = $$build FacebookArena Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FacebookArena-Linux-Shipping.commands = $$build FacebookArena Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FacebookArena-Linux-Test.commands = $$build FacebookArena Linux Test  -project="\"$$gameProjectFile\"" $$args
FacebookArena.commands = $$build FacebookArena Linux Development  -project="\"$$gameProjectFile\"" $$args

FacebookArenaEditor-Linux-Debug.commands = $$build FacebookArenaEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FacebookArenaEditor-Linux-DebugGame.commands = $$build FacebookArenaEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FacebookArenaEditor-Linux-Shipping.commands = $$build FacebookArenaEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FacebookArenaEditor-Linux-Test.commands = $$build FacebookArenaEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
FacebookArenaEditor.commands = $$build FacebookArenaEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	FacebookArena-Linux-Debug \
	FacebookArena-Linux-DebugGame \
	FacebookArena-Linux-Shipping \
	FacebookArena-Linux-Test \
	FacebookArena \
	FacebookArenaEditor-Linux-Debug \
	FacebookArenaEditor-Linux-DebugGame \
	FacebookArenaEditor-Linux-Shipping \
	FacebookArenaEditor-Linux-Test \
	FacebookArenaEditor \
